...
async function sonTeslimHatirlatmasiGonder(emailService: EmailService,
  ...
  if (!gonderildiMi) {
    ...
    console.log(
      `Uyarı: ${kayit.ogrenciEposta} için hatırlatma gönderilemedi, kayıt yine de geçerlidir.`);
  }
}
...
// Çıktı: E-posta gönderildi -> elif@ogrenci.mehmetakif.edu.tr | Konu: Son teslim tarihi
// yaklaşıyor: Java ile Programlama
// Çıktı: E-posta gönderilemedi: yasemin@gecersiz.example.com
// Çıktı: Uyarı: yasemin@gecersiz.example.com için hatırlatma gönderilemedi, kayıt yine
// de geçerlidir.
